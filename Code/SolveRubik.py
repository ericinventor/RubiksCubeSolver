...
# ------------------------- color experiments results -------------------------
# No. | BLUE      | WHITE     | GREEN     | ORANGE    | RED       | YELLOW    |
#     | R | G | B | R | G | B | R | G | B | R | G | B | R | G | B | R | G | B |
# -----------------------------------------------------------------------------
# 1   |61 |143|180|228|228|206|103|208|79 |178|62 |80 |244|92 |99 |229|230|90 | <- with foam
# 2   |49 |98 |128|184|188|165|76 |167|62 |215|70 |80 |125|47 |62 |186|203|65 | <- with foam
# 3   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |
...
if "-h" in sys.argv:
	print("-xoff")
	print("-yoff")
	#TODO deside what range is the best
